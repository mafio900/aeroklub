...
final class Routing {
    ...
    ['GET','/user/[i:id]/?', array('controller' => 'User', 'action' => 'showOne'), 'user_showOne'],
    ...
    ['GET','/user/formularz/?', array('controller' => 'User', 'action' => 'form'), 'user_form'],
    ...
    ['GET','/samolot/[i:id]/?', array('controller' => 'Samolot', 'action' => 'showOne'), 'samolot_showOne'],
    ...
    ['GET','/samolot/formularz/?', array('controller' => 'Samolot', 'action' => 'form'), 'samolot_form'],
    ...
    ['GET','/status/[i:id]/?', array('controller' => 'Status', 'action' => 'showOne'), 'status_showOne'],
    ...
    ['GET','/status/formularz/?', array('controller' => 'Status', 'action' => 'form'), 'status_form'],
    ['POST','/status/dodaj/?', array('controller' => 'Status', 'action' => 'add'), 'status_add'],
    //konfiguracja Usluga
    ['GET','/usluga/?', array('controller' => 'Usluga', 'action' => 'showAll'), 'usluga'],
    ['GET','/usluga/[i:id]/?', array('controller' => 'Usluga', 'action' => 'showOne'), 'usluga_showOne'],
    ...
    ['GET','/usluga/formularz/?', array('controller' => 'Usluga', 'action' => 'form'), 'usluga_form'],
