...
*/
class PDODatabase extends Model
{
    /**
    ...
    */
    public function selectAllOrderBy(
        ...
        try	{
            ...
            //$stmt->bindValue(':whe', $where, PDO::PARAM_STR);
    ...
    */
    ...
    /**
    * zmienia tablicę do postaci tablicy asocjacyjnej,
    * gdzie jedna z kolumn jest kluczem
    * @param  array $data       tablice wejściowa
    * @param  string $keyColumn kolumna, będąca kluczem tablica asocjacyjna
    * @return array
    */
    ...
    */
    public function transferToSelectable(
        $data,
        $valueColumns,
        $separator = ' ',
        $keyColumn = 'id'
